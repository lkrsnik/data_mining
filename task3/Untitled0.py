...
# ----------------- MEAN -------------------------
print (" ------------------- MEAN ------------------- ")
mean_int_res = (lasso_int_res + ridge_int_res + elastic_int_res + forest_int_res) / 4
IO.exportResults("output", intensity_dulition, legend, mean_int_res)
fscore = score(legend)
print ("MEAN INTENSITY: ")
print (fscore)

mean_res_res = (lasso_res_res + ridge_res_res + elastic_res_res + forest_res_res) / 4
IO.exportResults("output", rest_dulition, legend, mean_res_res)
fscore = score(legend)
print ("MEAN REST: ")
print (fscore)
...
#print (lasso_res_res)
#print (ridge_res_res)
#print (elastic_res_res)
#print (forest_res_res)
#print (mean_res_res)
...
ridge_stack = Orange.regression.linear.RidgeRegressionLearner(alpha = 20000)
...
def calculate_algorithm_rest(f, p):
    ...
    rest_result = []
    for i in range(rest_Y.shape[1]):
        data = Orange.data.Table(rest_X, rest_Y[:, i])
        model = lass(data)
